...
# Initialization of graph for TS
def init_graph_ts(prop):
    ...
    labels = [g_ea2,g_a2]
    return nx.Graph(tag=g_rxn_label, index=g_index,Ea2=g_ea2,A2=g_a2), labels
...
# XYZ file reader for ts reactions
