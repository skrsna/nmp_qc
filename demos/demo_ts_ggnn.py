...
parser.add_argument('--logPath', default='../log/ts/ggnn/', help='log path')
parser.add_argument('--plotLr', default=False, help='allow plotting the data')
parser.add_argument('--plotPath', default='../plot/ts/ggnn/', help='plot path')
parser.add_argument('--resume', default='../checkpoint/ts/ggnn/',
