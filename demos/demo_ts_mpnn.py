...
parser.add_argument('--logPath', default='../log/ts/mpnn/', help='log path')
parser.add_argument('--plotLr', default=False, help='allow plotting the data')
parser.add_argument('--plotPath', default='../plot/ts/mpnn/', help='plot path')
parser.add_argument('--resume', default='../checkpoint/ts/mpnn/',
