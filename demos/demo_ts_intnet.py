...
parser.add_argument('--logPath', default='../log/ts/intnet/', help='log path')
parser.add_argument('--plotLr', default=False, help='allow plotting the data')
parser.add_argument('--plotPath', default='../plot/ts/intnet/', help='plot path')
parser.add_argument('--resume', default='../checkpoint/ts/intnet/',
