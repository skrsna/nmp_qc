...
parser.add_argument('--dataset', default='ts', help='TS')
parser.add_argument('--datasetPath', default='../../../QMfiles/ts_xyz/', help='dataset path')
parser.add_argument('--logPath', default='../log/ts/duvenaud/', help='log path')
parser.add_argument('--plotLr', default=False, help='allow plotting the data')
parser.add_argument('--plotPath', default='../plot/ts/duvenaud/', help='plot path')
parser.add_argument('--resume', default='../checkpoint/ts/duvenaud/',
...
def main():
    ...
    test_ids = [files[i] for i in idx[100:150]]
    train_ids = [files[i] for i in idx[150:]]

    data_train = datasets.ts(root, train_ids)
    data_valid = datasets.ts(root, valid_ids)
